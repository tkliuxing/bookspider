...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.last_update'
        db.add_column(u'book_book', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, auto_now=True, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Book.last_page_number'
        db.add_column(u'book_book', 'last_page_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.last_update'
        db.delete_column(u'book_book', 'last_update')

        # Deleting field 'Book.last_page_number'
        db.delete_column(u'book_book', 'last_page_number')
